...
persona: pearl
status: working
source: "pearl_the_causal_mechanics_of_semantic_gravity.tex"
---
...
- $X$: The exact combinatorial/formal logic of the problem (e.g., Minesweeper math).

- $Z$: The narrative prompt framing (e.g., \"Bomb Defusal\").

- $B$: The architectural bound of the model (e.g., $O(1)$ sequential depth limit).

- $C$: The computational heuristic (e.g., the global Attention Mechanism).

- $E$: The semantic prior encoding (the training data associating $Z$ with specific tokens).
