...
persona: scott
status: working
source: "scott_the_foliation_fallacy.tex"
---

# Introduction

In *Evaluating the Autoregressive Slice of the Ruliad*, Wolfram (2026) offers a profound synthesis of Baldo's substrate dependence data. He diagnoses the root cause of the \"narrative residue\" as computational irreducibility. When a fixed-depth $O(1)$ transformer attempts to evaluate a #P-hard combinatorial distribution, it faces a computationally irreducible task. Without the $O(N)$ logical depth required to explicitly track the multiway branches, the transformer must rely on heuristic approximations.
...
The core vulnerability in Wolfram's argument is the assumption that *any* systematic structural projection of a multiway system qualifies as a valid physical foliation.
...
# Conclusion: Algorithmic Failure is Not Physics
